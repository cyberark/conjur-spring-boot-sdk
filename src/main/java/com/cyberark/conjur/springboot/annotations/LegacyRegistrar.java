...
public class LegacyRegistrar implements ImportBeanDefinitionRegistrar, BeanFactoryPostProcessor, EnvironmentAware {
	...
	public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
		...
		Collection<com.cyberark.conjur.springboot.core.env.LegacyConjurPropertySource> beans = beanFactory
				.getBeansOfType(com.cyberark.conjur.springboot.core.env.LegacyConjurPropertySource.class).values();
	...
	private void makeAndRegisterBean(BeanDefinitionRegistry registry, String[] values, String name) {
		for (String value : values) {
			if (!registry
					.containsBeanDefinition(com.cyberark.conjur.springboot.core.env.LegacyConjurPropertySource.class.getName()
							+ "-" + value + "@" + name)) {
				registerBeanDefinition(registry, com.cyberark.conjur.springboot.core.env.LegacyConjurPropertySource.class,
						com.cyberark.conjur.springboot.core.env.LegacyConjurPropertySource.class.getName() + "-" + value + "@"
								+ name,
						value, name);
			}
		}

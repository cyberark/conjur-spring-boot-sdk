 ...
 * @author bnasslahsen
 */
@SpringBootTest(classes = { ConjurRetrieveSecretServiceTest.class, SpringBootConjurAutoConfiguration.class,
		SecretApiMockConfig.class, ConjurPropertySourceConfiguration.class })
public class ConjurRetrieveSecretServiceTest {

	@Autowired
	private SecretsApi secretsApiMock;

	@Test public void testGetSecretCallsCount() throws ApiException { 
		// Verify the number of times the method was called 
		  verify(secretsApiMock,

 ...
 * com.cyberark.conjur.springboot.core.env.ConjurPropertySourceTest.
 ...
 *//**
	 ...
	 *//*
		 ...
		 * ConjurPropertySourceConfiguration.class, ConjurPropertySourceTest.class})
		 * public class ConjurPropertySourceTest {
		 * 
		 * @MockBean private SecretsApi secretsApi;
		 * 
		 * @Test public void testGetSecretCallsCount() throws ApiException { // Verify
		 * the number of times the method was called verify(secretsApi,
		 * times(3)).getSecret(any(), any(), any()); }
		 * 

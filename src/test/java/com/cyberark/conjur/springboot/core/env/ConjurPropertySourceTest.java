 ...
 * @author bnasslahsen
 */
@SpringBootTest(classes = { SpringBootConjurAutoConfiguration.class, ConjurPropertySourceConfiguration.class,
		ConjurPropertySourceTest.class })
public class ConjurPropertySourceTest {
	...
	public void testGetSecretCallsCount() throws ApiException {
		...
		verify(secretsApi, times(3)).getSecret(any(), any(), any());
	}
